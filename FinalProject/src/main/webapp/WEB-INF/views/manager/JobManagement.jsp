    ...
    <div class="modal-content">
      ...
      <form action="insertPos.do" method="post">
        ...
        <div class="modal-body">
          ...
          <input type="number" class="form-control mb-2 mr-sm-2" placeholder="등급을 입력하세요." required min="1" max="99" id="posGrade1" name="posGrade"> <br>
          <label for="posName1" class="mr-sm-2">추가할 직위 명</label>
          <input type="text" class="form-control mb-2 mr-sm-2" placeholder="직위 명을 입력하세요." pattern=".{1,10}" required title="직위 명은 필수 입력값입니다. 10자 이내로 작성해주세요." id="posName1" name="posName">
        </div>
        <!-- Modal footer -->
    ...
    <div class="modal-content">
      ...
      <form action="updatePos.do" method="post">
        ...
        <div class="modal-body">
          ...
          <input type="number" class="form-control mb-2 mr-sm-2" min="1" max="99" required id="posGrade2" name="posGrade">
          <label for="posName" class="mr-sm-2">직위 명</label>
          <input type="text" class="form-control mb-2 mr-sm-2" pattern=".{1,10}" required title="직위 명은 필수 입력값입니다. 10자 이내로 작성해주세요." id="posName2" name="posName">
        </div>
    ...
    <div class="modal-content">
      ...
      <form action="insertDept.do" method="post">
        ...
        <div class="modal-body">
          ...
          <input type="text" class="form-control mb-2 mr-sm-2" pattern=".{1,10}" required title="부서 명은 필수 입력값입니다. 10자 이내로 작성해주세요." placeholder="부서 명을 입력하세요." id="depName" name="depName">
        </div>
        <!-- Modal footer -->
        <div class="modal-footer">
    ...
    <div class="modal-content">
      ...
      <form action="updateDept.do" method="post">
        ...
        <div class="modal-body">
          ...
          <input type="text" class="form-control mb-2 mr-sm-2" pattern=".{1,10}" required title="부서 명은 필수 입력값입니다. 10자 이내로 작성해주세요." placeholder="부서 명을 입력하세요." id="depName2" name="depName">
        </div>
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" value="update" id="updateDepBtn" name="updateDepBtn" class="btn btn-primary">수정</button>
          <button type="submit" value="delete" id="deleteDepBtn" name="updateDepBtn" class="btn btn-danger">삭제</button>
        </div>
      </form>
    </div>
  </div>
