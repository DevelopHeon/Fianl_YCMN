...
<link
    ...
    rel='stylesheet' />
<script
    src='https://cdn.jsdelivr.net/combine/npm/fullcalendar@5.11.0/main.min.js,npm/fullcalendar@5.11.0'></script>
<!-- fullcalendar 언어 CDN -->
    ...
    $(function () {
        ...
        request.done(function (data) {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
            	...
            	//maxTime: '22:00:00',
                selectable: true,
                select: function (obj) { // 캘린더에서 드래그로 이벤트를 생성할 수 있다.
                    ...
                    for (var i = 0; i < allEvent.length; i++) {
                        ...
                        //obj.rezWriter = allEvent[i]._def.rezWriter; 	// 
                        //obj.rscNo = allEvent[i]._def.rscNo; 			// 100 넣었더니 다 100로나옴
                        events.push(obj);
                    }
