						...
						class="form-inline" enctype="multipart/form-data">
							<div class="form-group" style="line-height:2em;">
								...
								<label for="empName"> 기안자명 :</label>
									<input type="text" class="form-control"style="margin-left:1.8%;" id="empName" name="empName" value="${ appMap.approval.appWriterNo }" readonly>
									<br>
								...
								<div class="hiddenInfo">
									<input type="hidden" class="form-control" id="appTitle" name="appMap.approval.appTitle" value="${ appMap.approval.appTitle }">
							...
							<select name="appMap.approvalLeave.leaveCategory" class="form-control" style="margin-left:2.8%;" required>
							...
							<label for="leaveStart">기간 및 일시 :</label>
								<input class="form-control" style="margin-left:0.5%;" type="date" id="leaveStart" value="${appMap.approvalLeave.leaveStart}" name="appMap.approvalLeave.leaveStart" required />
							<label for="leaveFinish" style="margin-left:2%;">~</label>
								<input class="form-control" type="date" id="leaveFinish" name="appMap.approvalLeave.leaveFinish" value="${appMap.approvalLeave.leaveFinish}" required />
							<label for="leaveTotalDate" style="margin-left:5%;">사용 연차일 : </label>
								<input class="form-control" type="text" id="leaveTotalDate" name="appMap.approvalLeave.leaveTotalDate" value="${appMap.approvalLeave.leaveTotalDate}" placeholder="사용 연차 일수 작성" required />
							...
							<label for="leaveReason">휴가 사유 : </label>
								<textarea class="form-control" name="appMap.approvalLeave.leaveReason" id="leaveReason" rows="10" cols="50" style="resize:none;"><c:out value="${appMap.approvalLeave.leaveReason }"/></textarea>
						</div>
						<%-- <div class="errorCode" style="margin-left:5%;">
