                ...
                <div class="compose-mail">
                  ...
                  <form action="insertMail.do" id="insertMail" role="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" name="mailTitle" tabindex="1" id="subject" class="form-control" value="RE:${reply.mail.mailTitle }" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="mailTo" name="mailTo" value="${reply.empNo }" style="display:none"></input>
                      <span>${reply.employee.empName}</span>
